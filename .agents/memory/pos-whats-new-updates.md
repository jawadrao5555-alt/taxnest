...
- **Popup shows only the LATEST unseen row** — when announcing a feature + its guide together, create the guide row FIRST and the main announcement LAST so the announcement is the popup and the guide sits in the bell.
