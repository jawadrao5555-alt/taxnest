...
class Company extends Model
{
    ...
    protected $fillable = [
        ...
        'di_api_key_hash',
        'di_api_key_hint',
        'di_api_key_created_at',
        'di_api_key_last_used_at',
        ...
        'pos_auto_dayclose_time',
        'pos_business_day_cutoff',
        'pos_dayclose_unassigned_delivery_action',
        'order_match_style',
        'order_match_style_locked',
        'pos_token_counter',
        'pos_token_date',
        'pra_number_style',
        'local_number_style',
        ...
        'print_on_pay_dinein',
        'delivery_receipt_print_on_assign',
        'auto_print_kot',
        'pos_kds_auto_print',
        ...
        'offline_queue_depth',
        'offline_queue_oldest_at',
        'offline_queue_reported_at',
        'offline_queue_device',
        'agent_enabled',
        'agent_core_enabled',
        'agent_submits_pra',
    ...
    protected $casts = [
        ...
        'di_api_key_created_at' => 'datetime',
        'di_api_key_last_used_at' => 'datetime',
        ...
        'pos_auto_dayclose_time' => 'string',
        'pos_dayclose_unassigned_delivery_action' => 'string',
        'pos_cashier_dayclose' => 'boolean',
        'pos_cashier_order_cancel' => 'boolean',
        ...
        'delivery_receipt_print_on_assign' => 'boolean',
