...
class MadadgarLocalEngine
{
    ...
    private static function faqs(): array
    {
        return [
            ...
            ['p' => [['rider']],
             'a' => "Riders /pos/riders par bante hain — naam, phone, CNIC, vehicle number; \"Create Login\" se rider ka login banayen (rider sirf /pos/rider portal dekhta hai, team limit mein nahi ginta). Rider assign bill banne ke BAAD hota hai — sale screen ke GREEN \"Deliveries\" button (Delivery Board) ya /pos/deliveries se. Wahin se Dispatch/Delivered mark aur \"Settle Cash\" bhi hota hai. Riders feature Pro Max/Unlimited package mein hai."],
            ...
            ['p' => [['package'], ['upgrade']],
             'a' => "Packages (saalana): Starter Rs 9,999 (1 account, 500 final bills/mahina), Business Rs 14,999 (5 accounts, 2,000 bills), Pro Rs 24,999 (10 accounts, 3,000 bills, Restaurant module), Pro Max Rs 34,999 (Pro + Riders, Staff Hazri, QR Menu), Unlimited Rs 39,999 (sab unlimited + Custom Access). Tafseel aur payment /pos/billing par — bank details par raqam bhej kar payment proof upload karein, admin verify kar ke package activate karta hai."],
