...
export default function ClassicCBand() {
  const cartItems = [
    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="mx-auto max-w-[1366px]">
        ...
        <div className="flex gap-4">
          ...
          {/* RIGHT: Payment Column (~38%) — Variant C style totals card */}
          <div className="flex-[38] space-y-4">
            {/* Payment Card — C wala style: white card, halki lines, purple Grand Total */}
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  <button className="flex items-center gap-1 text-purple-600 hover:text-purple-700">
                    <span>Discount</span>
                    <kbd className="rounded bg-gray-100 px-1.5 py-0.5 font-mono text-xs text-gray-600">%</kbd>
                  </button>
