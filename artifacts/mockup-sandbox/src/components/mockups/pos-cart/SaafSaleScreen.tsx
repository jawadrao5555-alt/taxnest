...
function Kbd({ children, dark = false }: { children: string; dark?: boolean }) {
  return dark ? (
    <span className="text-[10px] font-bold rounded px-1.5 py-0.5 bg-gray-200 text-gray-600 border border-gray-300">
      {children}
    </span>
  ) : (
    ...
    <div className="min-h-screen bg-gray-50 font-sans text-gray-800 flex flex-col">
      ...
      <div className="relative z-20 flex items-center gap-3 px-3 h-12 shrink-0" style={{ background: "#0A4D5C" }}>
        ...
        <div className="relative flex items-center gap-1.5 ml-1">
          ...
          <div className="absolute top-10 right-0 w-64 rounded-lg bg-white border border-gray-200 shadow-lg p-2 space-y-1">
            ...
            <div className="text-[9px] text-gray-400 px-2 pb-0.5">Icon pe click se khulta hai — screen pe ab ye line nahi</div>
          </div>
        </div>
      ...
      <div className="flex flex-1 min-h-0">
        ...
        <div className="w-[460px] shrink-0 bg-white border-l border-gray-200 flex flex-col">
          ...
          <div className="flex-1 min-h-0 divide-y divide-gray-100 overflow-hidden">
            {items.map((it) => (
              <div key={it.name} className="px-3 py-2 flex items-center gap-2">
                <div className="flex-1 min-w-0">
                  <div className="text-[13px] font-medium text-gray-800 truncate">{it.name}</div>
