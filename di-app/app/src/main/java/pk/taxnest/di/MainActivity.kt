...
class MainActivity : Activity() {
    ...
    companion object {
        ...
        const val BRAND_COLOR = 0xFF059669.toInt()
        /** Primary button. */
        const val ACCENT_COLOR = 0xFFE7BF3B.toInt()
        const val ACCENT_TEXT_COLOR = 0xFF064E3B.toInt()
    ...
    private fun createWebView(): WebView {
        ...
        with(view.settings) {
            ...
            userAgentString = "$userAgentString TaxNestDIApp/${BuildConfig.VERSION_NAME}"
        }
    ...
    private fun buildBootScreen(): View {
        ...
        wrap.addView(ImageView(this).apply {
            setImageResource(R.drawable.ic_di)
