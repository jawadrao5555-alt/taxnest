...
class MainActivity : Activity() {
    ...
    // Fullscreen <video> support (ZFC, 5 Aug 2026): tutorial videos ka
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        web.webViewClient = object : WebViewClient() {
            ...
            override fun onPageStarted(view: WebView, url: String, favicon: android.graphics.Bitmap?) {
                ...
                // Instant push (Task #1142): first-party navigation past the
                // login page = logged in → register this device's FCM token
                // (session cookie auth); back on /pos/login = logged out →
        ...
        web.webChromeClient = object : WebChromeClient() {
            // Fullscreen video (ZFC, 5 Aug 2026): bina in overrides ke video ka
        ...
        // Instant push (Task #1142): Android 13+ needs a runtime prompt before
