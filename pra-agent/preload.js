...
contextBridge.exposeInMainWorld('agentAPI', {
  ...
  onConfigAutofilled: (callback) =>
    ipcRenderer.on('config-autofilled', (event, info) => callback(info)),
  ...
  lanCorePairingPayload: () => ipcRenderer.invoke('lan-core-pairing-payload'),
  lanCoreListDevices: () => ipcRenderer.invoke('lan-core-list-devices'),
  lanCoreRevokeDevice: (id) => ipcRenderer.invoke('lan-core-revoke-device', id),
