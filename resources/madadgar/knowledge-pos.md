...
- Multi-word search (Aug 2026): ek se zyada lafz likhein to har lafz naam ke kisi lafz se match hota hai — "cheese half" ya "cheese loaded half" se "Cheese Loaded Fries (Half)" mil jata hai. Bracket "(Half)" wale sizes bhi lafz ki tarah milte hain. Pehla lafz phir bhi naam ke shuru se hona chahiye (Any-word mode mein yeh bhi zaroori nahi). Yehi rule waiter screen par bhi hai.
...
- "Item search mein nahi mil raha": search naam ke SHURU se chalti hai — PEHLA lafz naam ke shuru se likhein (maslan "Chicken Roll" ke liye "chi" ya "chicken", sirf "roll" se nahi milega). Ek se zyada lafz likh sakte hain (Aug 2026): baqi alfaz naam ke kisi bhi lafz se mil jate hain — "cheese half" se "Cheese Loaded Fries (Half)" mil jata hai; bracket wale sizes bhi milte hain. Barcode/SKU poora ya digits ke saath likhein to woh bhi mil jata hai. Phir bhi na mile to /pos/products par check karein — product inactive to nahi? Search har category mein dhoondti hai.
