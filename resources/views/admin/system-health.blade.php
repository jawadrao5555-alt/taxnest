<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-bold text-xl text-gray-800 leading-tight">System Health Monitor</h2>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 p-6">
                    ...
                    <p class="mt-2 text-sm text-gray-500">Total retry attempts</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 p-6 mb-8">
                ...
                <div class="mt-4 grid grid-cols-3 gap-4 text-center">
                    <div class="p-3 rounded-lg {{ $healthScore >= 80 ? 'bg-green-50' : 'bg-gray-50' }}">
                        <p class="text-xs text-gray-500 uppercase">Queue</p>
                    ...
                    <div class="p-3 rounded-lg bg-gray-50">
                        <p class="text-xs text-gray-500 uppercase">FBR Today</p>
                        <p class="text-sm font-semibold text-gray-700">{{ $fbrSuccessToday }}/{{ $fbrLogsToday }} success</p>
                    </div>
                </div>
            </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-sm text-gray-600">{{ $log->user->name ?? 'Unknown' }}</td>
                                <td class="px-4 py-3 text-sm font-mono text-gray-500">{{ $log->ip_address }}</td>
