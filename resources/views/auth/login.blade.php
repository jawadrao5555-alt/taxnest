<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}" id="loginForm">
        ...
        <div class="mt-5 pt-5 border-t border-gray-200 dark:border-gray-700/60 text-center">
            <p class="text-xs text-gray-400 mb-2.5">You can use any of these to login:</p>
            <div class="flex justify-center gap-2 flex-wrap">
                <span class="inline-flex items-center gap-1 text-xs text-gray-500 dark:text-gray-400 px-2.5 py-1 rounded-full bg-gray-50/80 backdrop-blur-sm border border-gray-200 dark:border-gray-700/40">
