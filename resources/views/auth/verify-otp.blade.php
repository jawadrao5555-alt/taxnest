...
<head>
    ...
    <title>{{ __('pos.auth_otp_title') }} - TaxNest</title>
    ...
    <div class="w-full max-w-md mx-4">
        ...
        <div class="rounded-2xl p-8" style="background: rgba(255,255,255,0.06); border: 1px solid rgba(255,255,255,0.1); backdrop-filter: blur(20px);">
            <div class="text-center mb-6">
                ...
                <h2 class="text-xl font-bold text-white">{{ __('pos.auth_otp_heading') }}</h2>
                <p class="text-sm text-emerald-200/50 mt-2">{{ __('pos.auth_otp_sub') }}<br><span class="text-emerald-300 font-medium">{{ $email }}</span></p>
            </div>
            ...
            <div class="mb-4 p-3 rounded-lg" style="background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.08);">
                <p class="text-xs text-emerald-200/60 text-center">{{ __('pos.auth_otp_hint') }}</p>
            </div>
            ...
            <div class="mt-4 text-center">
                <p class="text-xs text-emerald-200/30">{{ __('pos.auth_otp_expiry') }}</p>
            </div>
        </div>
    </div>
</body>
