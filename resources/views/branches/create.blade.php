<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-bold text-xl text-gray-800 leading-tight">Add Branch</h2>
    ...
    <div class="py-8">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form method="POST" action="/branches" class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <textarea name="address" rows="3" class="w-full rounded-lg border-gray-300 shadow-sm focus:ring-emerald-500 focus:border-emerald-500">{{ old('address') }}</textarea>
                </div>
