            ...
            <form method="POST" action="/company/branding" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 p-6">
                    <label class="flex items-start gap-3 cursor-pointer">
                        <input type="checkbox" name="branding_enabled" value="1" @checked(session()->hasOldInput() ? old('branding_enabled') == '1' : $settings['enabled']) class="mt-1 rounded border-gray-300 text-emerald-600 focus:ring-emerald-500">
                        <span>
                ...
                <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 p-6">
                    ...
                    @endif
                    <input type="file" name="logo" accept=".png,.jpg,.jpeg" class="block w-full text-sm text-gray-600 dark:text-gray-300 file:mr-3 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-emerald-50 file:text-emerald-700 hover:file:bg-emerald-100 cursor-pointer">
                </div>

                {{-- Accent color --}}
                <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 p-6" x-data="{ accent: @js(old('accent_color', $settings['accent'] ?? '')) }">
                ...
                <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 p-6">
                    ...
                    <div class="space-y-3">
                        <input type="text" name="footer_line1" value="{{ old('footer_line1', $settings['footer_line1']) }}" maxlength="150" placeholder="Footer line 1" class="w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-white shadow-sm focus:ring-emerald-500 focus:border-emerald-500 text-sm">
                        <input type="text" name="footer_line2" value="{{ old('footer_line2', $settings['footer_line2']) }}" maxlength="150" placeholder="Footer line 2 (optional)" class="w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-white shadow-sm focus:ring-emerald-500 focus:border-emerald-500 text-sm">
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 p-6">
                    <label class="flex items-start gap-3 cursor-pointer">
                        <input type="checkbox" name="hide_platform_branding" value="1" @checked(session()->hasOldInput() ? old('hide_platform_branding') == '1' : $settings['hide_platform']) class="mt-1 rounded border-gray-300 text-emerald-600 focus:ring-emerald-500">
                        <span>
