        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form method="POST" action="/company/fbr-settings" x-data="fbrSettings()" class="space-y-6">
                ...
                <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-2xl shadow-lg shadow-black/5 border border-white/30 dark:border-gray-700/30 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="fbr_registration_no" value="{{ old('fbr_registration_no', $company->fbr_registration_no) }}" placeholder="e.g. 1234567890123" class="w-full rounded-lg bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm border-gray-200/50 shadow-sm focus:ring-emerald-500 focus:border-emerald-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">FBR Business Name</label>
                            <input type="text" name="fbr_business_name" value="{{ old('fbr_business_name', $company->fbr_business_name) }}" class="w-full rounded-lg bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm border-gray-200/50 shadow-sm focus:ring-emerald-500 focus:border-emerald-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-2xl shadow-lg shadow-black/5 border border-white/30 dark:border-gray-700/30 p-6">
                    ...
                    <div class="flex gap-4">
                        <label class="flex-1 flex items-center gap-3 px-4 py-3 rounded-lg border-2 cursor-pointer transition"
                            :class="environment === 'sandbox' ? 'border-amber-400 bg-amber-50/80 dark:bg-amber-900/20' : 'border-gray-200/50 dark:border-gray-700/30 hover:border-gray-300'">
                        ...
                        <label class="flex-1 flex items-center gap-3 px-4 py-3 rounded-lg border-2 cursor-pointer transition"
                            :class="environment === 'production' ? 'border-red-400 bg-red-50/80 dark:bg-red-900/20' : 'border-gray-200/50 dark:border-gray-700/30 hover:border-gray-300'">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-2xl shadow-lg shadow-black/5 border-2 border-amber-200/60 dark:border-amber-700/30 p-6">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex items-center gap-2">
                                <input type="text" name="fbr_sandbox_url" value="{{ old('fbr_sandbox_url', $company->fbr_sandbox_url ?? 'https://gw.fbr.gov.pk/di_data/v1/di/postinvoicedata_sb') }}" class="flex-1 rounded-lg bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm border-gray-200/50 shadow-sm focus:ring-amber-500 focus:border-amber-500 text-sm font-mono" placeholder="https://gw.fbr.gov.pk/...">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="password" name="fbr_sandbox_token" value="{{ old('fbr_sandbox_token', $sandboxToken) }}" placeholder="Enter sandbox API token" class="w-full rounded-lg bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm border-gray-200/50 shadow-sm focus:ring-amber-500 focus:border-amber-500">
                        </div>
                    ...
                    <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-2xl shadow-lg shadow-black/5 border-2 border-red-200/60 dark:border-red-700/30 p-6">
                        <div class="flex items-center gap-2 mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex items-center gap-2">
                                <input type="text" name="fbr_production_url" value="{{ old('fbr_production_url', $company->fbr_production_url ?? 'https://gw.fbr.gov.pk/di_data/v1/di/postinvoicedata') }}" class="flex-1 rounded-lg bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm border-gray-200/50 shadow-sm focus:ring-red-500 focus:border-red-500 text-sm font-mono" placeholder="https://gw.fbr.gov.pk/...">
                                <span class="text-xs text-gray-400 whitespace-nowrap">POST URL</span>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="password" name="fbr_production_token" value="{{ old('fbr_production_token', $productionToken) }}" placeholder="Enter production API token" class="w-full rounded-lg bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm border-gray-200/50 shadow-sm focus:ring-red-500 focus:border-red-500">
                        </div>
                ...
                <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-2xl shadow-lg shadow-black/5 border border-white/30 dark:border-gray-700/30 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div class="bg-gray-50/50 dark:bg-gray-900/20 rounded-lg p-4">
                        ...
                        <div class="bg-gray-50/50 dark:bg-gray-900/20 rounded-lg p-4" x-data="{ connectionStatus: '{{ $company->fbr_connection_status ?? 'unknown' }}' }">
                    ...
                    <div x-data="tokenHealth()">
                        ...
                        <button type="button" @click="testConn()" :disabled="testing" class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded-lg text-sm font-medium hover:bg-indigo-700 transition shadow-lg shadow-indigo-500/20 disabled:opacity-50">
                ...
                <div class="border-2 border-emerald-200/60 dark:border-emerald-700/30 rounded-2xl p-6 bg-emerald-50/80 dark:bg-emerald-900/20 backdrop-blur-sm" x-data="sandboxPanel()">
                    ...
                    <template x-if="environment === 'sandbox'">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                            <button type="button" @click="runTest('ping')" :disabled="running" class="p-3 border border-emerald-200/60 rounded-lg bg-white/70 dark:bg-gray-800/50 backdrop-blur-sm hover:bg-emerald-50 text-left transition">
                            ...
                            <button type="button" @click="runTest('token')" :disabled="running" class="p-3 border border-emerald-200/60 rounded-lg bg-white/70 dark:bg-gray-800/50 backdrop-blur-sm hover:bg-emerald-50 text-left transition">
                            ...
                            <button type="button" @click="runTest('payload')" :disabled="running" class="p-3 border border-emerald-200/60 rounded-lg bg-white/70 dark:bg-gray-800/50 backdrop-blur-sm hover:bg-emerald-50 text-left transition">
                            ...
                            <button type="button" @click="runTest('config')" :disabled="running" class="p-3 border border-emerald-200/60 rounded-lg bg-white/70 dark:bg-gray-800/50 backdrop-blur-sm hover:bg-emerald-50 text-left transition">
                            ...
                            <button type="button" @click="runTest('dryrun')" :disabled="running" class="p-3 border border-emerald-200/60 rounded-lg bg-white/70 dark:bg-gray-800/50 backdrop-blur-sm hover:bg-emerald-50 text-left transition">
                            ...
                            <button type="button" @click="runTest('provinces')" :disabled="running" class="p-3 border border-emerald-200/60 rounded-lg bg-white/70 dark:bg-gray-800/50 backdrop-blur-sm hover:bg-emerald-50 text-left transition">
                ...
                <div class="flex justify-end">
                    <button type="submit" class="px-6 py-2.5 bg-emerald-600 text-white rounded-lg font-medium hover:bg-emerald-700 transition shadow-lg shadow-emerald-500/20">Save FBR Settings</button>
                </div>
            </form>
        </div>
    </div>
