    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2.5 mb-5">
                ...
                <a href="/customer-profiles" class="premium-card group flex items-center space-x-3 p-3.5 bg-white dark:bg-gray-800/80 border border-gray-100/80 dark:border-gray-700/50 rounded-2xl hover:border-blue-300 dark:hover:border-blue-700 transition-all duration-300">
            ...
            <div class="premium-card bg-white dark:bg-gray-800/80 rounded-2xl shadow-sm border border-gray-100/80 dark:border-gray-700/50 p-5 mb-5">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-5">
                <div class="premium-card bg-white dark:bg-gray-800/80 rounded-2xl shadow-sm border border-gray-100/80 dark:border-gray-700/50 p-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-5">
                <div class="premium-card relative overflow-hidden bg-white dark:bg-gray-800/80 rounded-2xl shadow-sm border border-gray-100/80 dark:border-gray-700/50 p-5 group">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-5">
                <div class="premium-card bg-white dark:bg-gray-800/80 rounded-2xl shadow-sm border border-gray-100/80 dark:border-gray-700/50 overflow-hidden">
                    <div class="px-5 py-4 border-b border-gray-100/80 dark:border-gray-700/50 flex items-center justify-between">
