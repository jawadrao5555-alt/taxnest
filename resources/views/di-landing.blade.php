    ...
    <nav class="fixed top-0 w-full z-50 bg-white/70 backdrop-blur-2xl border-b border-white/30 shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
            <a href="/" class="flex items-center space-x-2">
                ...
                <span class="text-xl font-bold text-gray-900">Digital Invoice</span>
                <span class="text-xs text-gray-400 hidden sm:inline">by TaxNest</span>
            </a>
            <div class="hidden md:flex items-center space-x-8">
                ...
                <a href="/pos" class="text-sm font-medium text-gray-600 hover:text-emerald-600 transition">NestPOS</a>
            ...
            <div class="md:hidden flex items-center space-x-2">
                <a href="/login" class="text-xs font-semibold text-emerald-700 border border-emerald-600 px-3 py-1.5 rounded-lg">Login</a>
                <a href="/register" class="text-xs font-semibold text-white bg-emerald-600 px-3 py-1.5 rounded-lg">Sign Up</a>
            </div>
        </div>
    </nav>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row items-center justify-between">
                ...
                <div class="flex items-center space-x-6 text-sm text-gray-400">
                    ...
                    <a href="/pos" class="hover:text-white transition">NestPOS (PRA)</a>
