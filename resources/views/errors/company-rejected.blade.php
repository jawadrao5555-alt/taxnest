...
<head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover"><title>Registration Rejected</title><script src="https://cdn.tailwindcss.com"></script></head>
...
<body class="h-full bg-gray-50 flex items-center justify-center">
    <div class="text-center max-w-md px-6">
        ...
        <h1 class="text-2xl font-bold text-gray-900 mb-2">Registration Rejected</h1>
        <p class="text-gray-500 mb-6">Your company registration has been rejected. Please contact the administrator for more information.</p>
