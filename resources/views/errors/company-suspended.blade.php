...
<head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover"><title>Account Suspended</title><script src="https://cdn.tailwindcss.com"></script></head>
...
<body class="h-full bg-gray-50 flex items-center justify-center">
    <div class="text-center max-w-md px-6">
        ...
        <p class="text-gray-500 mb-6">Your company account has been suspended by the administrator. Please contact support for assistance.</p>
