...
<div class="space-y-5">
    ...
    <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl px-4 py-3 flex items-center gap-3 fb-anim fb-d1">
        ...
        <div><p class="text-[11px] font-bold text-blue-800 dark:text-blue-300">{{ __('pos.integrated_with_fbr') }}</p><p class="text-[9px] text-blue-600 dark:text-blue-400">POS #: {{ $company->fbr_pos_id }} | {{ ucfirst($company->fbr_pos_environment ?? 'sandbox') }}</p></div>
    </div>
    @endif
