...
<div class="space-y-5">
    ...
    <div class="bg-violet-50 dark:bg-violet-900/20 border border-violet-200 dark:border-violet-800 rounded-xl px-4 py-2.5 flex items-center gap-3 fbl-a fbl-2">
        ...
        <p class="text-[10px] font-bold text-violet-800 dark:text-violet-300">{{ __('pos.fbr_integrated_pos_line', ['id' => $company->fbr_pos_id, 'env' => ucfirst($company->fbr_pos_environment ?? 'sandbox')]) }}</p>
    </div>
    @endif
