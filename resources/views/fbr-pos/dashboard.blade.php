...
<div class="max-w-7xl mx-auto">
    ...
    <div class="mb-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl px-4 py-3 flex items-center gap-3">
        <div class="flex items-center justify-center w-10 h-10 rounded-lg bg-blue-600 flex-shrink-0">
            <svg class="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
        </div>
        <div>
            <p class="text-sm font-bold text-blue-800 dark:text-blue-300">Integrated with FBR</p>
            <p class="text-xs text-blue-600 dark:text-blue-400">POS Registration #: {{ $company->fbr_pos_id }} | Environment: {{ ucfirst($company->fbr_pos_environment ?? 'sandbox') }}</p>
        </div>
    </div>
    @endif
