...
<div class="max-w-7xl mx-auto">
    ...
    @endif
    @else
    {{-- Upgrade-locked card: plan lacks analytics_enabled (Pro on the FBR ladder) --}}
    <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-md p-8 mb-6 text-center">
        ...
        <a href="{{ route('fbrpos.billing') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-semibold rounded-lg hover:bg-blue-700 transition">{{ __('pos.upgrade_plan_btn') }}</a>
        @endif
    </div>
    @endif
