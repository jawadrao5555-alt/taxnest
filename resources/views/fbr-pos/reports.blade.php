    ...
    <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-md p-5 mb-6">
        <div class="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-3 mb-4">
            ...
            <form method="GET" action="{{ route('fbrpos.reports') }}" class="flex flex-wrap items-end gap-2">
                ...
                <button type="submit" class="px-4 py-2 bg-blue-600 text-white text-sm font-semibold rounded-lg hover:bg-blue-700 transition">Apply</button>
                <a href="{{ route('fbrpos.reports.analytics-pdf', ['from' => $ra->from, 'to' => $ra->to]) }}" class="px-4 py-2 bg-emerald-600 text-white text-sm font-semibold rounded-lg hover:bg-emerald-700 transition">PDF</a>
            </form>
        </div>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-5">
            <div class="p-3 rounded-lg bg-emerald-50 dark:bg-emerald-900/20 text-center">
                ...
                <p class="text-xs font-semibold text-emerald-700 dark:text-emerald-400 uppercase mt-0.5">FBR Submitted</p>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-5">
            <div>
                <h4 class="text-sm font-semibold text-gray-900 dark:text-white mb-2">Product Share (Top 10)</h4>
        ...
        <div class="mb-5">
            <h4 class="text-sm font-semibold text-gray-900 dark:text-white mb-2">Product Breakdown <span class="text-xs font-normal text-gray-500">(top 25 by revenue)</span></h4>
        ...
        if (trendEl) {
            new Chart(trendEl, {
                ...
                data: {
                    ...
                    datasets: [{ label: 'Revenue (PKR)', data: {!! $raJson($raDayValues) !!}, borderColor: '#2563eb', backgroundColor: 'rgba(37,99,235,0.12)', fill: true, tension: 0.3, pointRadius: 2 }]
                },
        ...
        if (hourEl) {
            new Chart(hourEl, {
                ...
                data: {
                    ...
                    datasets: [{ label: 'Revenue (PKR)', data: {!! $raJson($raHourValues) !!}, backgroundColor: '#2563eb', borderRadius: 3 }]
                },
