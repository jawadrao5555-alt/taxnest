        ...
        <div class="relative bg-white dark:bg-gray-900 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 w-full max-w-md p-5">
            ...
            <form method="POST" :action="'{{ url('/fbr-pos/riders') }}/' + (loginRider ? loginRider.id : '') + '/login'">
                ...
                <div class="space-y-3">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" required
                               ...
                               class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white text-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                ...
                <div class="flex justify-end gap-2 mt-5">
                    ...
                    <button type="submit" class="px-4 py-2 rounded-lg bg-blue-600 text-white text-sm font-semibold shadow-sm hover:bg-blue-700 transition"
