    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-4">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="{{ route('fbrpos.receipt', $transaction->id) }}" target="_blank" class="flex-1 text-center py-2.5 bg-indigo-600 text-white font-semibold rounded-lg hover:bg-indigo-700 transition text-sm">
                    Print Receipt
                </a>
                <a href="{{ route('fbrpos.pdf', $transaction->id) }}" class="flex-1 text-center py-2.5 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition text-sm">
                    Download PDF
                </a>
            </div>
