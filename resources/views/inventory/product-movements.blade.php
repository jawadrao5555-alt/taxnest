    ...
    <x-slot name="header">
        <div class="flex items-center justify-between flex-wrap gap-3">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-0.5">HS: {{ $product->hs_code }} | Stock Movement History</p>
            </div>
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            @forelse($movements as $mv)
                                ...
                                <tr class="{{ $loop->even ? 'bg-gray-50/50 dark:bg-gray-800/50' : '' }}">
                                    ...
                                    <td class="px-4 py-3 text-xs text-gray-500">{{ $mv->reference_number ?: '-' }}</td>
                                    <td class="px-4 py-3 text-xs text-gray-500 max-w-[150px] truncate">{{ $mv->notes ?: '-' }}</td>
