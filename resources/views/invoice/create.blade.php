            ...
            <form method="POST" action="/invoice/store" x-data="invoiceForm()" @submit="if (submitting) { $event.preventDefault(); return; } submitting = true;" @keydown.enter.prevent="focusNext($event)" @keydown.ctrl.s.prevent="saveDraft()" @keydown.meta.s.prevent="saveDraft()" @keydown.ctrl.enter.prevent="submitInvoice()" @keydown.meta.enter.prevent="submitInvoice()" @keydown.escape="closeModals()" class="space-y-6 pb-28">
                ...
                <div class="premium-card p-6">
                    ...
                    <div>
                        ...
                        <select name="branch_id" id="branch_id_select" @change="onBranchChange($event.target.value)" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 shadow-sm focus:ring-emerald-500 focus:border-emerald-500">
                ...
                <div class="premium-card p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <select name="document_type" x-model="document_type" @change="onDocTypeChange()" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 shadow-sm focus:ring-emerald-500 focus:border-emerald-500">
                ...
                <div class="premium-card p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="buyer_ntn" x-model="buyer_ntn" value="{{ old('buyer_ntn') }}" placeholder="Optional"
                                class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 shadow-sm focus:ring-emerald-500 focus:border-emerald-500">
                        ...
                        <div>
                            ...
                            <input type="text" name="buyer_cnic" x-model="buyer_cnic" value="{{ old('buyer_cnic') }}" maxlength="15" placeholder="Optional"
                                class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 shadow-sm focus:ring-emerald-500 focus:border-emerald-500">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        <div>
                            ...
                            <textarea name="buyer_address" x-model="buyer_address" required rows="2"
                                ...
                                class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 shadow-sm focus:ring-emerald-500 focus:border-emerald-500"></textarea>
                        ...
                        <div>
                            ...
                            <select name="destination_province" x-model="destination_province" required class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 shadow-sm focus:ring-emerald-500 focus:border-emerald-500">
                    ...
                    <template x-for="(item, index) in items" :key="index">
                        <div class="border border-gray-200 dark:border-gray-600 rounded-xl p-4 mb-4" :data-item-index="index">
                            ...
                            <div x-show="item.thirdScheduleRecommended" x-cloak class="mb-3 px-3 py-2 bg-amber-50 dark:bg-amber-900/30 border border-amber-300 dark:border-amber-700 rounded-lg">
                                ...
                                <p class="mt-1 text-xs text-amber-700 dark:text-amber-300" x-show="item.schedule_type === '3rd_schedule'">3rd Schedule has been selected. Please enter the retail/MRP below.</p>
        ...
        function invoiceForm() {
            ...
            function newItem() {
                return {
                    ...
                    hsLookupInfo: '',
                    hsUnmapped: false,
                    thirdScheduleRecommended: false,
                    thirdScheduleTaxRate: 18,
                    thirdScheduleOverrideAcknowledged: false,
            ...
            return {
                ...
                init() {
                    ...
                    // old('branch_id') may pre-select a branch on a validation bounce — sync services default rate.
                ...
                applyAiPrefill(p) {
                    ...
                    this.items.forEach((item, index) => this.lookupHsCode(index));
                },
                ...
                itemTotal(index) {
                    let item = this.items[index];
                    let sub = parseFloat(item.price || 0) * parseFloat(item.quantity || 0);
                    return (sub + parseFloat(item.tax || 0) + parseFloat(item.further_tax || 0)).toFixed(2);
                },
                onDocTypeChange() {},
                ...
                totalFurtherTax() {
                    return this.items.reduce((total, item) => {
                        return total + parseFloat(item.further_tax || 0);
                    }, 0).toFixed(2);
                },
                grandTotal() {
