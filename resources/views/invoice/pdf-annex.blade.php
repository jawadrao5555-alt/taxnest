@php
    ...
    // COMPLIANCE: the QR block, FBR invoice number and tax breakdown
...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .qr-inv-no { font-size: 11px; color: #111111; font-weight: 800; margin-top: 5px; letter-spacing: 0.2px; }
