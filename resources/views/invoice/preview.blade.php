            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div class="flex items-center space-x-2">
                        <a href="https://wa.me/?text={{ urlencode('Invoice ' . $invoice->display_invoice_number . "\nDownload PDF: " . url('/share/invoice/' . $invoice->share_uuid . '/pdf')) }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-green-500 text-white rounded-lg text-sm font-medium hover:bg-green-600 transition">
