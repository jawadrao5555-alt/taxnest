...
@php
    ...
    try {
        ...
        if ($wnAllowed && !$wnPending && !$wnReadonlyImp
            ...
            $whatsNewList = \App\Models\AppUpdate::whereIn('audience', ['fbr_pos', 'all'])->forCompanyFamily($fbrCompany)->where('is_published', true)
                ...
                <div class="flex items-center justify-between px-3 sm:px-5 h-12">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <div class="relative" x-data="{ bellOpen: false, unseen: {{ (int) $whatsNewUnseenCount }},
                            ...
                            <button @click="bellOpen = !bellOpen" title="{{ __('pos.ti_app_updates') }}" class="relative p-2 rounded-lg text-white hover:bg-white/15 transition cursor-pointer">
