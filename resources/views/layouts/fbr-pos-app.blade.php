            ...
            <header class="topnav-bar flex-shrink-0 relative z-50">
                <div class="flex items-center justify-between px-3 sm:px-5 h-12">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="{{ route('fbrpos.dashboard') }}" class="flex items-center gap-2 group">
                            <div class="w-7 h-7 rounded-lg bg-white/15 flex items-center justify-center group-hover:bg-white/25 transition">
                                <svg class="w-4 h-4 text-white/80" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z"/></svg>
                            </div>
                            <div class="hidden sm:block">
                                <span class="text-sm font-extrabold text-white tracking-tight">FBR POS</span>
                                <span class="text-[9px] text-white/30 ml-1 hidden lg:inline">by TaxNest</span>
                            </div>
                        </a>
                        ...
                        <nav class="hidden md:flex items-center gap-1">
                            <a href="{{ route('fbrpos.create') }}"
                               class="nav-pill px-3 py-1.5 rounded-lg text-xs font-semibold {{ request()->routeIs('fbrpos.create') ? 'active text-white' : 'text-white/70' }}">
                                New Sale
                            </a>
                        </nav>
                    </div>
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <div class="relative">
                            <button @click="profileOpen = !profileOpen" class="flex items-center gap-2 px-2 py-1 rounded-lg hover:bg-white/10 transition">
                                ...
                                <div class="hidden sm:block text-left">
                                    ...
                                    <p class="text-[9px] text-blue-200/50 leading-tight">{{ $companyName }}</p>
                                </div>
                                <svg class="w-3 h-3 text-white/40 hidden sm:block" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                            </button>
                        ...
                        <button @click="mobileMenuOpen = !mobileMenuOpen" class="md:hidden p-1.5 rounded-lg text-white/60 hover:text-white hover:bg-white/10 transition">
                ...
                <div x-show="mobileMenuOpen" x-cloak
                    ...
                    <a href="{{ route('fbrpos.create') }}" class="nav-pill px-3 py-1.5 rounded-lg text-[11px] font-medium {{ request()->routeIs('fbrpos.create') ? 'active text-white' : 'text-white/60' }}">New Sale</a>
                </div>
            </header>
