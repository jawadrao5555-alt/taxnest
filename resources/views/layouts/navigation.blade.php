<div class="flex flex-col h-full">
    ...
    <nav class="flex-1 overflow-y-auto sidebar-scroll px-3 py-3 space-y-0.5">
        ...
        <a href="/company/profile" class="sidebar-link flex items-center gap-3 py-3 px-4 rounded-lg text-sm {{ request()->is('company/fbr*') || request()->is('company/profile*') ? 'active text-gray-900 dark:text-white' : 'text-gray-600 dark:text-gray-400' }}">
    ...
    <div class="flex-shrink-0 p-3">
        <div class="rounded-xl bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-1">
            <a href="/company/profile" class="sidebar-link flex items-center gap-3 py-2.5 px-3 rounded-lg text-sm text-gray-600 dark:text-gray-400">
