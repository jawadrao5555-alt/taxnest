                        ...
                        <div class="relative">
                            ...
                            <div x-show="profileOpen" x-cloak @click.outside="profileOpen = false"
                                ...
                                <div class="py-1.5 max-h-[65vh] overflow-y-auto">
                                    ...
                                    {{-- Local Bills report — admin-only, fully isolated from PRA reports
                                         (Sales/Tax Reports show ONLY PRA bills; this shows ONLY local bills). --}}
                                    @if(auth('pos')->user()?->isPosAdmin())
                                    <a href="{{ route('pos.local.index') }}" class="menu-link flex items-center gap-2.5 px-4 py-2 text-[12px] font-medium text-gray-700 dark:text-gray-300">
                                        <svg class="w-4 h-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                                        Local Bills Report
                                    </a>
                                    @endif
