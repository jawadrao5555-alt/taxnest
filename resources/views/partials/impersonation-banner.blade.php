...
@if(is_array($__imp) && !empty($__imp['readonly']))
    <div style="position:fixed;top:10px;left:50%;transform:translateX(-50%);z-index:2147483000;max-width:calc(100vw - 16px);">
        <div class="flex items-center gap-2 sm:gap-3 rounded-full bg-amber-500 text-black shadow-xl px-3 sm:px-4 py-1.5 border border-amber-600">
