...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    {{-- ═══ Biometric CSV / Excel Import (4 Aug 2026) ═══
    ...
    <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6">
        <form method="POST" action="{{ route('pos.bio-sync.process-import') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-5">
                ...
                <input type="file" name="punch_file" required accept=".csv,.txt,.xlsx,.xls"
                       class="w-full text-sm text-gray-700 dark:text-gray-200 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-purple-50 dark:file:bg-purple-900/30 file:text-purple-700 dark:file:text-purple-300 hover:file:bg-purple-100 dark:hover:file:bg-purple-900/50 transition">
            ...
            <div class="mb-6">
                ...
                <select name="device_id" class="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 text-sm px-3 py-2 focus:ring-2 focus:ring-purple-500 transition">
            ...
            <button type="submit" class="px-6 py-2.5 bg-purple-600 text-white text-sm font-semibold rounded-lg hover:bg-purple-700 transition">
