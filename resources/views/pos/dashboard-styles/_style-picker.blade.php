<div class="flex items-center gap-2 flex-shrink-0" x-data="{ styleOpen: false, currentStyle: '{{ $dashboardStyle ?? 'default' }}' }">
    <div class="relative">
        <button @click="styleOpen = !styleOpen" @click.away="styleOpen = false" class="p-2 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-500 hover:text-purple-600 transition shadow-sm" title="Dashboard Style">
