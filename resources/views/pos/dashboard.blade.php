...
<div class="w-full overflow-x-hidden">
    <div class="px-4 sm:px-6 py-4 max-w-7xl mx-auto">
        ...
        {{-- ━━━ Stranded-day warning (Task 466): prior business day(s) never closed.
             Compact echo of the day-close page's detailed banner (Task 455) —
             links there when the user may close days; info-only otherwise. ━━━ --}}
        ...
        <div class="mb-4 p-3 rounded-xl bg-red-50 dark:bg-red-900/20 border border-red-300 dark:border-red-800 flex items-center gap-3">
            ...
            <a href="{{ route('pos.day-close', ['date' => $unclosedPriorDays->first()]) }}"
