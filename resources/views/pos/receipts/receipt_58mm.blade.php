...
<body>
    ...
    <div class="invoice-numbers" style="text-align:center; padding:3px 4px;">
        ...
        @unless($rcptIsDailyStyle)<span style="font-size:8px; font-weight:700; color:#000;">{{ __('pos.daily_token_label') }}</span><br>@endunless
        <span style="font-size:18px; font-weight:bold; color:#000; line-height:1.15;">{{ $rcptBillToken }}</span>
        @unless($rcptIsDailyStyle)<br><span style="font-size:8px; font-weight:600; color:#000;">{{ __('pos.bill_serial_label') }}: {{ $transaction->invoice_number }}</span>@endunless
        @else
    ...
    <div class="invoice-numbers">
        ...
        <table class="inv-table">
            ...
            <tr>
                <td class="inv-label" style="font-size:8px; font-weight:600; color:#000;">{{ __('pos.bill_serial_label') }}:</td>
