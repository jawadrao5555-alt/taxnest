...
<body>
    ...
    {{-- Payment breakdown — shown only when ≥2 pos_payments rows exist (split
         ...
         relationLoaded so old-schema receipts render without error. --}}
    @php
        $rcptSplitPayments = [];
        try {
    ...
    <table class="totals-table" style="margin:2px 0;">
        <tr>
            <td class="tot-label" colspan="2" style="font-size:10px; text-transform:uppercase; letter-spacing:0.4px; padding-bottom:1px;">{{ __('pos.payment_breakdown') }}</td>
        </tr>
