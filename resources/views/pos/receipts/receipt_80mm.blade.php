...
<body>
    ...
    <div class="separator"></div>
    <div style="font-size:10px; font-weight:700; color:#000; padding:2px 0; font-style:italic;">Note: {{ $transaction->notes }}</div>
    @endif
    ...
    <div class="qr-code">
        ...
        <p style="font-size: 10px; color: #000; font-weight: 600;">{{ $qrCaption }}</p>
    </div>
    @endif
    @endif
