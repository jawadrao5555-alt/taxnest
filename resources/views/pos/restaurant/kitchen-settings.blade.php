...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <form method="POST" action="{{ route('pos.restaurant.kitchen-settings.update') }}" class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 divide-y divide-gray-200 dark:divide-gray-700">
            ...
            {{-- Task 1356: bill final ho aur kitchen ne lines dekhi hi na hon to
                 ticket khud chali jaye (default ON — owner video, dine-in Table 02). --}}
            <div class="p-5 flex items-center justify-between">
                <div>
                    <h3 class="text-sm font-semibold text-gray-900 dark:text-white">{{ __('pos.kot_on_final_if_unsent_title') }}</h3>
                    <p class="text-xs text-gray-500 mt-0.5">{{ __('pos.kot_on_final_if_unsent_hint') }}</p>
                </div>
                <label class="relative inline-flex items-center cursor-pointer">
                    <input type="hidden" name="kot_on_final_if_unsent" value="0">
                    <input type="checkbox" name="kot_on_final_if_unsent" value="1" {{ (($company->kot_on_final_if_unsent ?? true) !== false) ? 'checked' : '' }} class="sr-only peer">
                    <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-purple-300 dark:peer-focus:ring-purple-800 rounded-full peer dark:bg-gray-600 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-500 peer-checked:bg-purple-600"></div>
                </label>
            </div>
            ...
            <div class="divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <div class="p-5 flex items-center justify-between">
                    ...
                    <label class="relative inline-flex items-center cursor-pointer">
                        ...
                        <input type="checkbox" name="kot_show_kitchen_notes" value="1" {{ ($company->kot_show_kitchen_notes ?? false) ? 'checked' : '' }} class="sr-only peer">
                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-purple-300 dark:peer-focus:ring-purple-800 rounded-full peer dark:bg-gray-600 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-500 peer-checked:bg-purple-600"></div>
                    </label>
                </div>
                <div class="p-5">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            {{-- Task 756/757: NULL = never made an explicit choice.
                                 Print CSS already renders NULL as LEFT (v6-safe fix).
                                 Pre-select LEFT here too so the UI matches what the
                                 kitchen ticket actually prints. Saving Center is an
                                 explicit opt-in (owner-warned below). --}}
