<x-pos-layout>
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6" data-service-workflow="{{ $profile['category'] }}">
    <div class="flex flex-wrap items-start justify-between gap-3 mb-6">
        ...
        <div class="flex gap-2"><a href="{{ route('pos.service-work-orders.report') }}" class="px-4 py-2 rounded-lg border text-sm dark:border-gray-700 dark:text-gray-200">Export CSV</a><a href="{{ route('pos.service-work-orders.create') }}" class="px-4 py-2 rounded-lg bg-purple-600 text-white text-sm font-bold">New {{ $profile['noun'] }}</a></div>
    </div>
