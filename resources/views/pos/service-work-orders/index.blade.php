<x-pos-layout>
<div class="tn-page tn-services-page max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 min-w-0" data-service-workflow="{{ $profile['category'] }}">
    <div class="tn-page-header flex flex-wrap items-start justify-between gap-3 mb-6">
    ...
    <div class="tn-service-queue tn-table-shell bg-white dark:bg-gray-900 rounded-xl border dark:border-gray-800 overflow-hidden shadow-sm">
