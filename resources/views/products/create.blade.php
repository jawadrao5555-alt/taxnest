<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <form method="POST" action="/products" class="space-y-6" id="productForm">
                @csrf
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        <div>
                            ...
                            <select name="schedule_type" required class="w-full rounded-lg border-gray-300 shadow-sm focus:ring-emerald-500 focus:border-emerald-500" id="scheduleType">
                                ...
                                <option value="standard" {{ old('schedule_type') === 'standard' ? 'selected' : '' }}>Standard</option>
                                <option value="reduced" {{ old('schedule_type') === 'reduced' ? 'selected' : '' }}>Reduced</option>
                                <option value="3rd_schedule" {{ old('schedule_type') === '3rd_schedule' ? 'selected' : '' }}>3rd Schedule</option>
                                <option value="exempt" {{ old('schedule_type') === 'exempt' ? 'selected' : '' }}>Exempt</option>
                                <option value="zero_rated" {{ old('schedule_type') === 'zero_rated' ? 'selected' : '' }}>Zero Rated</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="number" step="1" min="0" max="100" name="default_tax_rate" id="taxRateInput" value="{{ old('default_tax_rate', '18') }}" required
                                class="w-full rounded-lg border-gray-300 shadow-sm focus:ring-emerald-500 focus:border-emerald-500">
                    ...
                    <div id="sroSection" class="mb-6 hidden">
                        <div class="p-4 bg-amber-50 border border-amber-200 rounded-lg">
                            ...
                            <input type="text" name="sro_reference" id="sro_reference" value="{{ old('sro_reference') }}" placeholder="e.g., SRO 1125(I)/2011"
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" step="0.01" min="0" name="default_price" value="{{ old('default_price', '0.00') }}" required
                                class="w-full rounded-lg border-gray-300 shadow-sm focus:ring-emerald-500 focus:border-emerald-500">
