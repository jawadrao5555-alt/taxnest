<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8" x-data="productForm()">
            <form method="POST" action="/products/{{ $product->id }}" class="space-y-6" id="productForm" @submit="validateForm($event)">
                @csrf
                @method('PUT')
                ...
                <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 p-6">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Barcode <span class="text-gray-400 text-xs">(Optional)</span></label><input type="text" name="barcode" value="{{ old('barcode', $product->barcode) }}" class="w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-white shadow-sm"></div>
                            <div><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">SKU <span class="text-gray-400 text-xs">(Optional)</span></label><input type="text" name="sku" value="{{ old('sku', $product->sku) }}" class="w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-white shadow-sm"></div>
                        </div>
                        <div>
    ...
    function productForm() {
        return {
            scheduleType: '{{ old("schedule_type", $product->schedule_type ?? "") }}',
