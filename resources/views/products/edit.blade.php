<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <form method="POST" action="/products/{{ $product->id }}" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="hs_code" value="{{ old('hs_code', $product->hs_code) }}" required placeholder="8471.3010"
                                class="w-full rounded-lg border-gray-300 shadow-sm focus:ring-emerald-500 focus:border-emerald-500">
                        ...
                        <div>
                            ...
                            <input type="text" name="schedule_type" value="{{ old('schedule_type', $product->schedule_type) }}"
                                class="w-full rounded-lg border-gray-300 shadow-sm focus:ring-emerald-500 focus:border-emerald-500">
