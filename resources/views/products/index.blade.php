        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <form method="GET" action="/products" class="flex flex-col sm:flex-row gap-3">
                    ...
                    @if($search)
                    <a href="/products" class="px-4 py-2 bg-gray-200 text-gray-700 dark:text-gray-300 rounded-lg text-sm font-medium hover:bg-gray-300 transition">Clear</a>
                    @endif
                </form>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-50 dark:bg-gray-800">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">MRP</th>
                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">SRO</th>
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        @forelse($products as $product)
                            @php
                                ...
                                $badges = [
                                    'standard' => 'bg-gray-100 text-gray-800 dark:text-gray-100',
                                ...
                                $badgeClass = $badges[$product->schedule_type] ?? 'bg-gray-100 text-gray-800 dark:text-gray-100';
                            @endphp
                            <tr class="even:bg-gray-50/50 dark:even:bg-gray-800/50 hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                                ...
                                <td class="px-4 py-3 whitespace-nowrap">
                                    ...
                                    @else
                                        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800 dark:text-gray-100">Inactive</span>
                                    @endif
                                </td>
