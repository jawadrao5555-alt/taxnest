                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center flex-wrap gap-2">
                            ...
                            <div x-data="{ open: false }" class="relative">
                                ...
                                <div x-show="open" @click.away="open = false" class="absolute right-0 mt-1 w-48 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 z-50">
                                    <a href="{{ route('reports.wht.pdf', array_merge(request()->query(), ['view' => 'whole'])) }}" class="block px-4 py-2 text-xs text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-t-lg">Whole Report PDF</a>
                                    <a href="{{ route('reports.wht.pdf', array_merge(request()->query(), ['view' => 'partywise'])) }}" class="block px-4 py-2 text-xs text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-b-lg">Party-wise PDF</a>
                                </div>
                            </div>
                            @php
