...
<body class="bg-gray-100 min-h-screen">
    <div class="max-w-4xl mx-auto py-8 px-4">
            ...
            <div class="p-6 border-b border-gray-100">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-3">
                        <p class="text-xs text-gray-500 dark:text-gray-400 uppercase font-medium">Buyer</p>
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-3 text-sm text-gray-700 dark:text-gray-300">{{ $item->description }}</td>
                        <td class="px-6 py-3 text-sm text-gray-700 dark:text-gray-300 text-right">{{ $item->quantity }}</td>
                        <td class="px-6 py-3 text-sm text-gray-700 dark:text-gray-300 text-right">PKR {{ number_format($item->price, 2) }}</td>
                        <td class="px-6 py-3 text-sm text-gray-700 dark:text-gray-300 text-right">PKR {{ number_format($item->tax, 2) }}</td>
        ...
        <div class="flex items-center justify-center space-x-4">
            ...
            <button onclick="window.print()" class="inline-flex items-center px-6 py-3 bg-gray-600 text-white rounded-lg font-medium hover:bg-gray-700 transition">
