...
| 1.7.2   | 12          | **Secure Bill Preview** — assigned rider sees item names and grand total by default; owner-controlled optional disclosure; assignment-revision and lifecycle guards discard stale responses |
| 1.7.3   | 13          | **Safe Rider Reassignment + Lean Tracking** — mistaken assignments can be changed with revision-CAS protection; old-rider cards/outbox work are invalidated; duplicate GPS/network work is reduced while durable tracking and offline sync remain intact |
