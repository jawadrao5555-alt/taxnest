...
$fixture = [
    ...
    'readOnlyJourneys' => array_merge([
        ...
        ['name' => 'fiscal', 'login' => $fiscalUser->email, 'password' => $password, 'loginPath' => '/fbr-pos/login', 'paths' => ['/fbr-pos/create'], 'markers' => ['New FBR POS Sale'], 'mainMarkers' => ['New FBR POS Sale'], 'usableSelectors' => ['[x-ref="barcodeInput"]']],
