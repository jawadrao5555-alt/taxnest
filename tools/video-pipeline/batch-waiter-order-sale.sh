#!/bin/bash
# Record the dedicated waiter-order-to-sale tutorial.
# Run as the Replit "Video Batch" console workflow so the multi-minute
# Playwright process is not killed when an interactive shell exits.
set -o pipefail
cd "$(dirname "$0")/../.."
